...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tr.com.khg.criteria.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tr.com.khg.criteria.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, tr.com.khg.criteria.domain.User.class.getName());
            createCache(cm, tr.com.khg.criteria.domain.Authority.class.getName());
